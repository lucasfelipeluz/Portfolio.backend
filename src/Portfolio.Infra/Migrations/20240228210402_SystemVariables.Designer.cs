...
namespace Portfolio.Infra.Migrations
{
    ...
    [Migration("20240228210402_SystemVariables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portfolio.Domain.Entities.ProjectImage", b =>
                {
                    ...
                    b.ToTable("projects_images", (string)null);
                });
            ...
            modelBuilder.Entity("Portfolio.Domain.Entities.SkillImage", b =>
                {
                    b.Property<int>("SkillId")
                        .HasColumnType("int")
                        .HasColumnName("skill_id");
                    ...
                    b.HasKey("SkillId", "ImageId");

                    b.HasIndex("ImageId");

                    b.ToTable("skills_images", (string)null);
                });

            modelBuilder.Entity("Portfolio.Domain.Entities.SystemVariable", b =>
                {
                    b.Property<string>("Name")
                        .HasColumnType("VARCHAR(100)")
                        .HasColumnName("name");
            ...
            modelBuilder.Entity("Portfolio.Domain.Entities.ProjectImage", b =>
                {
                    b.HasOne("Portfolio.Domain.Entities.Image", "Image")
                        .WithMany()
